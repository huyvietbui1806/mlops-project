...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--train-log-output", type=str, required=True)
    parser.add_argument("--test-log-output", type=str, required=True)
    parser.add_argument("--train-tree-output", type=str, required=True)
    parser.add_argument("--test-tree-output", type=str, required=True)
